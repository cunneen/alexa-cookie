/**
 * HTTP body for device registration call to endpoint  
 *    `https://api.amazonalexa.com/v1/devices/@self/capabilities`
 */
export const capabilitiesBody = {
  legacyFlags: {
    SUPPORTS_COMMS: true,
    ...
    },
    {
      ...
      configurations: {
        catalogs: [
          {
            type: "IOS_APP_STORE",
            identifierTypes: ["URI_HTTP_SCHEME", "URI_CUSTOM_SCHEME"],
          },
        ],
      },
      version: "0.2",
